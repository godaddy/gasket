...
[Quick Start Guide]. From there, reference the guides to start developing
 your apps and making your frameworks.

The following contents are similar to those when using the **docs** command
enabled by [@gasket/plugin-docs] which is recommended for reading docs of apps.
The different sections consolidate elements enabled by various Gasket packages.
Clicking a link will take you to docs for that package for further details.
