...
| ------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- | ------------------------------ |
| [bundleAnalyzerConfig]          | This plugin uses [webpack-bundle-analyzer] to tune both browser and server analysis reports                                                                                        | object                                 | {}                             |
...
| [docsify.config]                | Any [Docsify configuration] property except for functions types that are not currently supported. Default has `auth2top` and `relativePath` set to `true`, with `maxLevel` at `3`. | object                                 |                                |
