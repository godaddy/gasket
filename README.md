...
| ----------------------- | ------- | ------------------------------------------ |
| [@gasket/preset-api]    | 6.47.1  | Create Express-based API with Gasket       |
| [@gasket/preset-nextjs] | 6.47.1  | Basic NextJS Framework                     |
...
| [@gasket/plugin-express]        | 6.47.1  | Adds express support to your application                                   |
