...
| Name                            | Version | Description                                                                |
| ------------------------------- | ------- | -------------------------------------------------------------------------- |
| [@gasket/plugin-analyze]        | 6.46.4  | Gasket Analyzer Plugin                                                     |
...
| [@gasket/plugin-https]          | 6.46.4  | Create http/s servers with graceful termination                            |
| [@gasket/plugin-intl]           | 6.46.4  | NodeJS script to build localization files.                                 |
...
| [@gasket/plugin-nextjs]         | 6.46.4  | Adds Next support to your application                                      |
...
| [@gasket/cli]                                            | 6.46.4  | CLI for rapid application development with gasket                                    |
