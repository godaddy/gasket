...
| [@gasket/plugin-docusaurus]     | 6.34.4  | Gasket plugin for docusaurus                                               |
| [@gasket/plugin-elastic-apm]    | 6.34.4  | Adds Elastic APM instrumentation to your application                       |
| [@gasket/plugin-express]        | 6.34.4  | Adds express support to your application                                   |
...
| [@gasket/plugin-swagger]        | 6.34.4  | Generate and serve swagger docs                                            |
| [@gasket/plugin-webpack]        | 6.34.4  | Adds webpack support to your application                                   |
| [@gasket/plugin-workbox]        | 6.34.4  | Gasket Workbox Plugin                                                      |
...
| Name                       | Version | Description                                                                          |
| -------------------------- | ------- | ------------------------------------------------------------------------------------ |
| [@gasket/assets]           | 6.34.4  | Gasket assets                                                                        |
| [@gasket/cli]              | 6.34.4  | CLI for rapid application development with gasket                                    |
| [@gasket/data]             | 6.34.4  | Helper package for accessing embedded Gasket Data in the browser                     |
| [@gasket/engine]           | 6.34.4  | Plugin engine for gasket                                                             |
| [@gasket/fetch]            | 6.34.4  | Gasket Fetch API                                                                     |
| [@gasket/helper-intl]      | 6.34.4  | Internal helpers used by loaders to resolve locale file paths                        |
| [@gasket/log]              | 6.34.4  | Gasket client and server logger                                                      |
| [@gasket/nextjs]           | 6.34.4  | Gasket integrations for Next.js apps                                                 |
