...
| [@gasket/plugin-lifecycle]      | 6.24.2  | Allows a gasket/ directory to be used for lifecycle hooks in applications. |
| [@gasket/plugin-lint]           | 6.24.0  | Adds GoDaddy standard linting to your application                          |
| [@gasket/plugin-log]            | 6.24.2  | Gasket log plugin                                                          |
| [@gasket/plugin-manifest]       | 6.24.2  | The web app manifest for progressive Gasket applications                   |
| [@gasket/plugin-metadata]       | 6.24.2  | Adds metadata to gasket lifecycles                                         |
| [@gasket/plugin-metrics]        | 6.24.2  | Collect metrics for gasket commands                                        |
| [@gasket/plugin-mocha]          | 6.24.0  | Integrates mocha based testing in to your Gasket application               |
| [@gasket/plugin-morgan]         | 6.24.2  | Adds morgan request logger to your app                                     |
| [@gasket/plugin-nextjs]         | 6.24.2  | Adds Next support to your application                                      |
| [@gasket/plugin-redux]          | 6.24.2  | Gasket Redux Setup                                                         |
| [@gasket/plugin-service-worker] | 6.24.2  | Gasket Service Worker Plugin                                               |
| [@gasket/plugin-start]          | 6.24.2  | Adds commands for building and starting Gasket apps                        |
| [@gasket/plugin-swagger]        | 6.24.2  | Generate and serve swagger docs                                            |
| [@gasket/plugin-webpack]        | 6.24.2  | Adds webpack support to your application                                   |
| [@gasket/plugin-workbox]        | 6.24.2  | Gasket Workbox Plugin                                                      |
...
| [docsify.config]                | Any [Docsify config] properties, expect for functions types which are not currently supported.
          Default has `auth2top` and `relativePath` set to `true`, with `maxLevel` at `3`. | object                           |                       |
| [docsify.port]                  | Port to serve the docs from                                                                                                                                                               | number                           | 3000                  |
| [docsify.port][7]               | Port to serve the docs from                                                                                                                                                               | number                           | 3000                  |
| [docsify.scripts]               | Optional additional stylesheet URLs to load                                                                                                                                               | string[]                         |                       |
...
| [intl.defaultPath]              | Path to endpoint with JSON files                                                                                                                                                          | string                           |                       |
...
| [intl.modules]                  | Enable locale files collation from node modules                                                                                                                                           | boolean/object                   | true                  |
...
| [nextConfig][11]                | Everything you can configure in the `next.config.js` can be added here                                                                                                                    | object                           |                       |
| [redux]                         | Redux plugin config object                                                                                                                                                                | object                           |                       |
| [redux.initState]               | initial state to include in the store                                                                                                                                                     | string                           |                       |
...
| [serviceWorker.url]             | Name the service worker file                                                                                                                                                              | string                           | /sw.js                |
...
| [swagger]                       | The base gasket.config object                                                                                                                                                             | object                           |                       |
...
| [workbox.outputDir]             | path of directory to copy Workbox libraries to                                                                                                                                            | string                           | ./build/workbox       |
...
[7]:/packages/gasket-plugin-docsify/README.md#configuration
