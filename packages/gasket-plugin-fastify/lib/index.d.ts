...
declare module '@gasket/core' {
  ...
  type ErrorHandler = (error: Error, req: FastifyRequest, res: FastifyReply, next: (error?: Error) => void) => void;
...
export function alignLogger(logger: Logger): FastifyBaseLogger;
