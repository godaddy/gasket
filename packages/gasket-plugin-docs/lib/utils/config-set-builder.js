...
class DocsConfigSetBuilder {
   ...
   * @param {import('@gasket/plugin-metadata').ModuleData} moduleData - Metadata
   * for a module
   * @param {import('../index').DocsSetup} docsSetup - Docs setup
   ...
   * docConfig.
   * @param {import('../index').DocsTransform[]} transforms - Transforms to
   * segregate
   * @returns {import('../index').DocsTransform[]} remaining local transforms
   * @private
   */
   ...
   * @param {import('@gasket/plugin-metadata').ModuleData} moduleData - Metadata
   * for a module
   * @param {import('../index').DocsSetup} docsSetup - Files to include and
   * transforms
