...
export type LocaleHandler_loadStatics = (...localeFilePaths: LocaleFilePath[]) => Promise<void>;
export type LocaleHandler_load = (...localeFilePaths: LocaleFilePath[]) => Promise<void>;
