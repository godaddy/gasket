...
describe('@gasket/template-api-fastify', () => {
  describe('template structure', () => {
    ...
    it('should have proper package.json structure', () => {
      ...
      expect(packageJson.name).toBe('fastify-ts');
      ...
      expect(packageJson.dependencies).toHaveProperty('@gasket/plugin-fastify');
  ...
  describe('gasket configuration', () => {
    it('should have valid gasket.ts file', () => {
      ...
      expect(gasketContent).toContain("import pluginFastify from '@gasket/plugin-fastify'");
      ...
      expect(gasketContent).toContain('pluginFastify');
  ...
  describe('plugins', () => {
    it('should have valid routes plugin', () => {
      ...
      expect(routesContent).toContain('fastify(gasket, app)');
  ...
  describe('swagger configuration', () => {
    it('should have valid swagger.json', () => {
      ...
      expect(swagger.info).toHaveProperty('title', 'fastify-ts');
  ...
  describe('test setup', () => {
    ...
    it('should have example test file', () => {
      ...
      expect(testContent).toContain("import { defaultHandler } from '../plugins/routes-plugin.js'");
      expect(testContent).toContain("import { describe, it, expect, beforeEach, vi } from 'vitest'");
      expect(testContent).toContain("describe('Routes'");
      expect(testContent).toContain('defaultHeader should use expected message');
    });
  });
  ...
  describe('documentation', () => {
    it('should have comprehensive README', () => {
      ...
      expect(readmeContent).toContain('# fastify-ts');
      expect(readmeContent).toContain('Gasket App');
