...
describe('withGasketData', function () {
  ...
  describe('renders GasketDataScript', function () {
    ...
    //   const wrapper = render(<WrappedDocument { ...mockProps } />);
    //   assume(container.querySelector('body').find(GasketDataScript)).length(1);
    // });
  ...
  //     // from parent
  //     assume(container.querySelector(Html)).length(1);
  //     assume(container.querySelector(Head)).length(1);
  //     assume(container.querySelector('body').find(Main)).length(1);
  //     assume(container.querySelector('body').find(NextScript)).length(1);
  //     assume(container.querySelector('body').find('p')).length(1);
  //   });
  ...
  //     const wrapper = render(<WrappedDocument { ...mockProps } />);
  //     assume(container.querySelector('body').children().at(0).name()).equals('Main');
  //     assume(container.querySelector('body').children().at(1).name()).equals('GasketDataScript');
  //     assume(container.querySelector('body').children().at(2).name()).equals('NextScript');
  //   });
  ...
  //     const wrapper = render(<WrappedDocument { ...mockProps } />);
  //     assume(container.querySelector('body').children().at(0).name()).equals('div');
  //     assume(container.querySelector('body').children().at(1).name()).equals('GasketDataScript');
  //     assume(container.querySelector('body').children().at(2).name()).equals('script');
  //     assume(container.querySelector('body').children().at(3).name()).equals('NextScript');
  //   });
  ...
  //     assume(container.querySelector('body').children().at(0).name()).equals('div');
  //     assume(container.querySelector('body').children().at(1).name()).equals('GasketDataScript');
  //     assume(container.querySelector('body').children().at(2).name()).equals('div');
  //   });
  ...
  //     const wrapper = render(<WrappedDocument { ...mockProps } />);
  //     assume(container.querySelector('body').children().at(0).name()).equals('header');
  //     assume(container.querySelector('body').children().at(1).name()).equals('Main');
  //     assume(container.querySelector('body').children().at(2).name()).equals('script');
  //     assume(container.querySelector('body').children().at(3).name()).equals('div');
  //     assume(container.querySelector('body').children().at(4).name()).equals('GasketDataScript');
  //     assume(container.querySelector('body').children().at(5).name()).equals('footer');
  //     assume(container.querySelector('body').children().at(6).name()).equals('NextScript');
  //   });
  });
});
